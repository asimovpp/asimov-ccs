...
module ccs_base
  ...
  character(len=128), parameter, public :: left = "left"
  character(len=128), parameter, public :: right = "right"
  character(len=128), parameter, public :: bottom = "bottom"
  character(len=128), parameter, public :: top = "top"
