...
#include "ccs_macros.inc"
  ...
  call create_vector(vec_properties, "u", u%values)
  call create_vector(vec_properties, "v", v%values)
  call create_vector(vec_properties, "w", w%values)
  call create_vector(vec_properties, "p", p%values)
  call create_vector(vec_properties, "dpdx", p%x_gradients)
  call create_vector(vec_properties, "dpdy", p%y_gradients)
  call create_vector(vec_properties, "dpdz", p%z_gradients)
  call create_vector(vec_properties, "p_prime", p_prime%values)
  call create_vector(vec_properties, "dp_primedx", p_prime%x_gradients)
  call create_vector(vec_properties, "dp_primedy", p_prime%y_gradients)
  call create_vector(vec_properties, "dp_primedz", p_prime%z_gradients)
  ...
  call create_vector(vec_properties, "dudx", u%x_gradients)
  call create_vector(vec_properties, "dudy", u%y_gradients)
  call create_vector(vec_properties, "dudz", u%z_gradients)
  call create_vector(vec_properties, "dvdx", v%x_gradients)
  call create_vector(vec_properties, "dvdy", v%y_gradients)
  call create_vector(vec_properties, "dvdz", v%z_gradients)
  call create_vector(vec_properties, "dwdx", w%x_gradients)
  call create_vector(vec_properties, "dwdy", w%y_gradients)
  call create_vector(vec_properties, "dwdz", w%z_gradients)
