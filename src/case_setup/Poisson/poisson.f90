...
module problem_setup
  ...
  use meshing, only: get_face_location, set_cell_location, get_centre
...
program poisson
  ...
  use meshing, only: set_cell_location, get_face_location, set_neighbour_location, get_local_num_cells
