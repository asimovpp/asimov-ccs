!> Program file for CambridgeSpraySwirlFlame case
program cssf
#include "ccs_macros.inc"
  ...
  call run_solver(par_env, run_options, eval_sources, postproc_cssf, flow_fields)
...
contains
  ...
  subroutine postproc_cssf(par_env, flow_fields)
