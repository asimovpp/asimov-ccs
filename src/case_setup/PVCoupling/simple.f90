...
program simple
  ...
  call create_vector(vec_sizes, "u", u%values)
  call create_vector(vec_sizes, "v", v%values)
  call create_vector(vec_sizes, "w", w%values)
  call create_vector(vec_sizes, "p", p%values)
  call create_vector(vec_sizes, "dpdx", p%x_gradients)
  call create_vector(vec_sizes, "dpdy", p%y_gradients)
  call create_vector(vec_sizes, "dpdz", p%z_gradients)
  call create_vector(vec_sizes, "p_prime", pp%values)
  call create_vector(vec_sizes, "dp_primedx", pp%x_gradients)
  call create_vector(vec_sizes, "dp_primedy", pp%y_gradients)
  call create_vector(vec_sizes, "dp_primedz", pp%z_gradients)
  ...
  call set_size(par_env, square_mesh, vec_sizes)
  call create_vector(vec_sizes, "mf", mf%values)
