...
must follow the Fortran 2018 standard and the file extenion \texttt{.f90} should be used by default. In order to 
...
\begin{itemize}
    ...
    \item If needed, put detailed information into the body of the commit message. Using \texttt{git commit} without the \texttt{-m} option will open a text editor for the message -- this is a convenient way to write a commit message with both a subject line and body. 
