...
\begin{itemize}
  ...
  \item Any bugs that are discovered during testing and development must be documented using the issue tracker and marked using the ``bug'' label.
  ...
  be documented.
  \item Issues that are actively being worked on must be moved from the ``todo'' to the ``doing'' board.
