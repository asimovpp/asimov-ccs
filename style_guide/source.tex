...
All code must follow the Fortran 2018 standard and the file extenion \texttt{.f18} should be used by default. In order to verfiy that the standard is being following, the code should 
be built with compile-time checks for standard adherence enabled:
\begin{itemize}
