!> @brief Submodule file parallel_mpi_env.smod
!>
!> @details Implementation (using MPI) of the parallel interface

submodule (parallel) parallel_mpi_env
...
contains
  ...
  end submodule parallel_mpi_env